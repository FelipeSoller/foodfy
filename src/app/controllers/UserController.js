    ...
    async post(req, res) {
        try {
            ...
            const welcomeEmail = `
                ...
                <p>
                    Seja bem-vindo(a) ao Foodfy
                </p>
                <p>
                    Seu cadastro foi realizado com sucesso! Confira seus seus dados abaixo:
                </p>
                <p>
                    Login: ${email}
                </p>
                ...
                <br>               
                <p>
                    Para acessar sua conta, clique no botão abaixo e entrar com seu email e senha utilizados no cadastro.
				</p>
